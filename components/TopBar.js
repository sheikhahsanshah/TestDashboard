    ...
    return (
        <div className="flex items-center justify-between p-3 h-[68px] bg-gray-800 text-gray-300 border-b border-gray-700 shadow-sm sticky top-0 z-10">
                        ...
                        <ul>
                            {suggestions.map((suggestion) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={`text-xs px-1.5 py-0.5 rounded-full ${suggestion.type === "Alumne"
            ...
            <div className="flex items-center space-x-4">
                ...
                <div
                    className="flex items-center space-x-2 cursor-pointer p-1 rounded-lg hover:bg-gray-700"
                    onClick={() => {
                        router.push('/login')
                    }}
                >
                    <div className="w-8 h-8 rounded-full border border-gray-600 bg-gray-700 flex items-center justify-center text-gray-200 font-medium">
                        {user?.avatar || user?.name?.charAt(0) || "U"}
                    </div>
                    <span className="text-sm font-medium text-gray-200 hidden sm:inline">{user?.name || "Usuari"}</span>
                </div>
            </div>
        </div>
    )
