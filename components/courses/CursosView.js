...
const CursosView = () => {
  ...
  const filteredAndSortedCourses = getSortedCourses(filteredCourses)
        ...
        <table className="min-w-full divide-y divide-gray-700">
          <thead className="bg-gray-700">
            <tr className="">
              ...
              >
                Descripció <SortIcon column="description" />
              </th>
              <th
                scope="col"
                className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-600"
              ...
              >
                Alumnes <SortIcon column="studentCount" />
              </th>
              <th
                scope="col"
                className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-600"
              ...
              >
                Professors <SortIcon column="teacherCount" />
              </th>
              <th
                scope="col"
                className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-600"
              ...
              >
                Periode <SortIcon column="startDate" />
              </th>
