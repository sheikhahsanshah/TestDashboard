...
const FilterDropdown = ({ title, options, icon, searchable = false, selectedValues, onSelectionChange }) => {
    ...
    const getDisplayValue = () => {
        ...
        if (!selectedValues || selectedValues.length === 0) return title
        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <div className="flex items-center space-x-2 overflow-hidden">
                    ...
                    <span
                        className={`font-medium truncate ${(Array.isArray(selectedValues) ? selectedValues?.length > 0 : !!selectedValues) ? "text-blue-400" : ""
                            }`}
