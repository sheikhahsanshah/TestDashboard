...
import { MapPin, Building, User, BookOpen, CreditCard, CheckCircle } from "lucide-react"
...
// Modal Component for Filters (Updated for Pagaments)
const FilterModal = ({ isOpen, onClose, onApplyFilters, initialFilters, title }) => {
  ...
  const renderFilters = () => {
    ...
    // Add other filter sets here if needed
    return null
  }
