...
const StudentDetailView = ({ student: studentProp, onNavigateBack, onUpdateStudent }) => {
  const [activeTab, setActiveTab] = useState("seguiment")
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "avaluacio":
        return <div className="p-4 text-gray-400">Contingut de la pestanya Avaluació...</div>
      case "dades":
        return <div className="p-4 text-gray-400">Contingut de la pestanya Dades...</div>
      default:
        return null
    }
  }
